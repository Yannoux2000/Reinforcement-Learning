...
#INFO : 
#cet algo ressemble plus au a3c (sans asynchronous car mon pc ne pourai pas le supporter... je pense)
...
# 	for intermediate_layer in [0,5,10,15]:
...
if intermediate_layer==Separated_Networks:
	#if the networks are separated then they should get direct access to the states
...
writer = tf.summary.FileWriter("./TB/{}Final/InterLayer{}-LearnRate{}-G{}-B{}/".format(env_name,intermediate_layer,learning_rate,gamma,beta))
